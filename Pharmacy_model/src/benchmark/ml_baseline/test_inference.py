...
def _print_result(query: str, disease_code: str, category_raw: str, result: object, latency: float) -> None:
    print("-" * 24)
    print(f"Query: {query}")
...
def main() -> None:
    ...
    for query in QUERIES:
        ...
        category_raw = predictor._lookup_category_key(disease_code)
